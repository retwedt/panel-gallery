...
for (var i=0; i<galleries.length; i++) {
	...
	galleries[i].querySelector("p").textContent = bios[startNum];
...
for (var i = 0; i < buttons.length; i++) {
	...
	buttons[i].addEventListener("click", function() {
		...
		galleryText.textContent = bios[this.id];
